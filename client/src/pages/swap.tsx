...
export default function Swap() {
  ...
  return (
    <div className="min-h-screen w-full max-w-full overflow-x-hidden bg-gradient-to-br from-hyper-navy via-slate-900 to-slate-800">
      ...
      {/* Main Content */}
      <main className="w-full max-w-6xl mx-auto px-2 sm:px-6 lg:px-8 py-2 sm:py-8">
        <div className="flex flex-col lg:flex-row lg:space-x-8 space-y-8 lg:space-y-0">
          ...
          <div className="hidden lg:block w-1/2 space-y-6">
            ...
            <Card className="bg-slate-800/90 backdrop-blur-md border-hyper-mint/30">
              <CardHeader className="pb-4">
                <CardTitle className="text-lg font-bold text-white flex items-center">
                  <TrendingUp className="w-5 h-5 mr-2 text-hyper-mint" />
                  DEX Analytics
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="grid grid-cols-2 gap-4">
                  <div className="bg-slate-900/40 rounded-lg p-3">
                    ...
                    <p className="text-lg font-bold text-white">$47.8M</p>
                    <p className="text-xs text-green-400">+12.3%</p>
                  </div>
                  <div className="bg-slate-900/40 rounded-lg p-3">
                    <p className="text-xs text-gray-400">Total Value Locked</p>
                    <p className="text-lg font-bold text-white">$127.3M</p>
                  ...
                  <div className="bg-slate-900/40 rounded-lg p-3">
                    ...
                    <p className="text-xs text-hyper-mint">+2.1%</p>
                  </div>
                </div>
              </CardContent>
            </Card>
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-white">Smart Contract Audit</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <CheckCircle className="w-4 h-4 text-green-400" />
                      <span className="text-sm text-white">Multi-sig Security</span>
                    </div>
                    <Badge variant="secondary" className="bg-green-400/20 text-green-400">
                      Active
                    </Badge>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="text-sm text-white">Bug Bounty Program</span>
                    </div>
                  ...
                  <div className="flex items-center justify-between">
                    <div className="flex items-center space-x-2">
                      <Zap className="w-4 h-4 text-hyper-mint" />
                      <span className="text-sm text-white">MEV Protection</span>
                    </div>
                    <Badge variant="secondary" className="bg-hyper-mint/20 text-hyper-mint">
                      Enabled
                    </Badge>
                  </div>
                </div>
            ...
            <Card className="bg-slate-800/90 backdrop-blur-md border-hyper-mint/30">
              <CardHeader className="pb-4">
                <CardTitle className="text-lg font-bold text-white flex items-center">
                  <Clock className="w-5 h-5 mr-2 text-hyper-mint" />
                  Performance
                </CardTitle>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-white">Average Swap Time</span>
                    <span className="text-sm font-medium text-hyper-mint">1.2s</span>
                  </div>
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-white">Gas Optimization</span>
                    <span className="text-sm font-medium text-green-400">35% Saved</span>
                  </div>
                  <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center justify-between">
                    <span className="text-sm text-white">Slippage Protection</span>
