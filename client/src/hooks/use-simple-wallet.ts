    ...
    try {
      ...
      if (!ethereum) {
        ...
        // Try Trust Wallet
          ...
          // In development/iframe environments, provide clear guidance
          console.log('❌ No wallet providers detected');
          throw new Error('No wallet extension detected. Install MetaMask, OKX, or Trust Wallet in your browser, then deploy this app to a real domain to test wallet functionality.');
        }
      } else {
